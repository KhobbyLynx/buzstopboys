...
const SingleTeam = ({ team }: { team: TeamType }) => {
  const { image, name, designation, facebookLink, twitterLink, instagramLink } =
    team;
  return (
    <div className="w-4/5 sm:w-1/2 lg:w-1/4 xl:w-1/4 px-8">
      <div className="group mb-8 rounded-xl  bg-blue-200 px-5 pb-10 pt-12 shadow-testimonial">
        <div className="relative z-10 mx-auto mb-3 h-[140px] w-[140px]">
          <Image
            src={image}
            alt={name}
            ...
            height={120}
          />
          <span className="absolute bottom-10 left-0 -z-10 h-10 w-10 rounded-full bg-secondary opacity-0 transition-all group-hover:opacity-100">
          <svg
              width="55"
              height="53"
              viewBox="0 0 55 53"
