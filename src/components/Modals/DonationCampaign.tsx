...
function DonationCampaignModal({
  toggleModal,
  show,
  img,
  target,
          ...
          <Slide direction="down" in={show} timeout={500}>
            ...
            >
              ...
              <Box className="flex justify-between items-center my-3">
                <Typography className="text-center pt-1 pb-2 font-normal text-green-900 uppercase">
                  Target: {formatAmount(target)}
                </Typography>
                <Typography className="text-center pt-1 pb-2 font-normal text-blue-900 uppercase">
                  Raised: {formatAmount(raised)}
                </Typography>
              </Box>
