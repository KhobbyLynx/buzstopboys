 ...
 const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      if(handleRegisterPatron.fulfilled.match(resultAction)) {
        ...
        if (typeof resultAction.payload === 'string' && resultAction.payload.includes('auth/email-already-in-use')) {
          setError('password', {
            type: 'manual',
  ...
  return (
    <Box className='content-center' sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '100vh', backgroundColor: '#f9fafb' }}>
      <Card>
            ...
            <FormControlLabel
              ...
              label={
                <Box sx={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap', justifyContent: 'center' }}>
                  ...
                  <Typography component={LinkStyled} href='/' onClick={e => e.preventDefault()} sx={{ marginLeft: '4px' }}>
...
>
  {loading ? <CircularProgress size={24} color="inherit" /> : 'Sign up'}
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap', justifyContent: 'center' }}>
              <Typography sx={{ color: '#6b7280', marginRight: '8px' }}>Already have an account?</Typography>
