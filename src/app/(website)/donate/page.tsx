...
import { getDonationOptions, getDonationsCampaigns } from './src/store/donations'
import DonationCampaign from './src/view/donations/DonationCampaign'
import DonationCards from './src/view/donations/DonationCards'
